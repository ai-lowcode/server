 ...
 */
DROP DATABASE IF EXISTS `al_system`;
CREATE DATABASE  `al_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
SET NAMES utf8mb4;
...
CREATE TABLE `sys_code_build`  (
                                   ...
                                   `api_prefix` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口路径前缀 例如:/oauth2/user接口前缀为oauth2(不传会使用packageName，最底层包名 例如:cn.com.axel.sys包会使用sys)',
                                   `entity_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '实体类名(不传会使用表名驼峰化)',
                                   `package_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目包名(不传使用默认包名 cn.com.axel.sys)',
