/**
  ...
  根据个人使用场景选择是否初始化
 */
DROP DATABASE IF EXISTS `al_demo`;
CREATE DATABASE  `al_demo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
SET NAMES utf8mb4;
...
INSERT INTO `demo_data_scope` VALUES (4, NULL, NULL, '624edadc0562c7fe9b54f0e3ba5e658b', 'Axel开发部', '', NULL, '', NULL);
INSERT INTO `demo_data_scope` VALUES (5, NULL, NULL, '76f3d1d15272858c2523f287aea955f9', 'Axel测试部', '', NULL, '', NULL);
INSERT INTO `demo_data_scope` VALUES (6, NULL, NULL, '8b7bbf1cac1af7faca6dd2686981fb22', 'Axel事业部', '', NULL, '', NULL);
INSERT INTO `demo_data_scope` VALUES (7, NULL, NULL, 'a2569f85d5cd316f5c7011e43dc86271', 'XXX开发部', '', NULL, '', NULL);
INSERT INTO `demo_data_scope` VALUES (8, NULL, NULL, 'af30f104a622b5de76add210dd33b361', 'Axel运维部', '', NULL, '', NULL);
