package cn.com.axel.common.log.aspect;
...
import cn.com.axel.common.log.service.AsyncSaveLog;
...
public class LogAspect {
    ...
    @Before("@annotation(cn.com.axel.common.log.annotation.Log)")
    ...
    @AfterReturning(value = "@annotation(cn.com.axel.common.log.annotation.Log)", returning = "returnValue")
    public void doAfterReturning(Object returnValue) {
        setReturn(0, JSON.toJSONString(returnValue));
    }

    @AfterThrowing(value = "@annotation(cn.com.axel.common.log.annotation.Log)", throwing = "e")
