package cn.com.axel.common.dblink.query;

import cn.com.axel.common.core.exception.MyRuntimeException;
import cn.com.axel.common.core.secret.SM2Utils;
...
public class QueryHandler {
    static final AlPageHelper pageHelper = new AlPageHelper();

    /**
     * 查询数据 通过AlPageHelper.start进行分页
     *
    ...
    /**
     * 查询数据通过RowBounds进行分页
     * 如果存在AlPageHelper.start优先使用AlPageHelper.start分页
     *
     * @param dataSourceOptions 连接属性
     * @param strSql            无参sql
