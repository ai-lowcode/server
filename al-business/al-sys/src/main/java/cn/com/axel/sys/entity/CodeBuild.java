package cn.com.axel.sys.entity;
...
public class CodeBuild extends BaseEntity<Long> {
    ...
    @Schema(description = "接口路径前缀 例如:/oauth2/user接口前缀为oauth2(不传会使用packageName，最底层包名 例如:cn.com.axel.sys包会使用sys)")
    private String apiPrefix;
    @Schema(description = "实体类名(不传会使用表名驼峰化)")
    private String entityName;
    @Schema(description = "项目包名(不传使用默认包名 cn.com.axel.sys)")
